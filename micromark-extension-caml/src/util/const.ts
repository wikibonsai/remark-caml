...
export const keyUsableCharCodes = {
  space: 32,
  quotationMark: 34, // `"`
  numberSign: 35, // `#`
  dollarSign: 36, // `$`
...
export const enum CamlToken {
  // construct //
  camlAttr          = 'camlAttr',

  // key
  camlKeyPrfxMarker = 'camlKeyPrfxMarker',
  camlKeyTxt        = 'camlKeyTxt',
  camlKeyMarker     = 'camlKeyMarker',
  listLineEnding    = 'listLineEnding',
  // val
  camlValTxt        = 'camlValTxt',
  // 
  camlListBullet    = 'camlListBullet',
  camlListComma     = 'camlListComma',
}
